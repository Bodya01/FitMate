...
{
    public sealed class YourFitnessTrackerContext : IdentityDbContext<FitnessUser>
    {
        ...
        public YourFitnessTrackerContext(DbContextOptions<YourFitnessTrackerContext> options) : base(options) { }
