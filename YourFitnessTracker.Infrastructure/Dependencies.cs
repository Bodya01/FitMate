...
namespace YourFitnessTracker.Infrastructure;
...
public static class Dependencies
{
    ...
    private static class Core
    {
        ...
        public const string Dependencies = "YourFitnessTracker.Core.Dependencies";
    ...
    {
        public const string Path = "YourFitnessTracker.Business";
        public const string Dependencies = "YourFitnessTracker.Business.Dependencies";
