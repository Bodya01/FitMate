...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitMate.DAL.Entities.WorkoutActivity", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("FitMate.DAL.Entities.WorkoutSession", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("FitMate.DAL.Entities.WorkoutActivity", b =>
                {
                    b.HasOne("FitMate.DAL.Entities.WorkoutSession", "Session")
                        .WithMany("Activities")
            ...
            modelBuilder.Entity("FitMate.DAL.Entities.WorkoutSession", b =>
                {
                    b.HasOne("FitMate.DAL.Entities.WorkoutPlan", "Plan")
                        .WithMany("Sessions")
